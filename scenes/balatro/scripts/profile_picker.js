  ...
  window.BiscaProfile = {
    ...
    open(name) {
      ...
      root.innerHTML = `<style>
        .bisca-profile{background:#fff0cc;color:#214f50;border:3px solid #347667;border-radius:22px;box-shadow:5px 6px #153536;padding:22px;box-sizing:border-box;width:min(520px,94vw);max-height:94dvh;overflow:auto;text-align:center;font:700 17px system-ui;touch-action:auto}
